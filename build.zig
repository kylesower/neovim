...
pub fn build(b: *std.Build) !void {
    ...
    nvim_exe.root_module.addIncludePath(b.path("src"));
    nvim_exe.root_module.addIncludePath(gen_config.getDirectory());
    nvim_exe.root_module.addIncludePath(gen_headers.getDirectory());
